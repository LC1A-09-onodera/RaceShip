...
void Rewired::KeyCodeString::KeyCodeStringInit()
{
	...
	sA.CreateSprite( ConvertStringToWchaer(path + "A.png"), XMFLOAT3(0, 0, 0) );
	sB.CreateSprite( ConvertStringToWchaer(path + "B.png"), XMFLOAT3(0, 0, 0) );
	sC.CreateSprite( ConvertStringToWchaer(path + "C.png"), XMFLOAT3(0, 0, 0) );
	sD.CreateSprite( ConvertStringToWchaer(path + "D.png"), XMFLOAT3(0, 0, 0) );
	sE.CreateSprite( ConvertStringToWchaer(path + "E.png"), XMFLOAT3(0, 0, 0) );
	sF.CreateSprite( ConvertStringToWchaer(path + "F.png"), XMFLOAT3(0, 0, 0) );
	sG.CreateSprite( ConvertStringToWchaer(path + "G.png"), XMFLOAT3(0, 0, 0) );
	sH.CreateSprite( ConvertStringToWchaer(path + "H.png"), XMFLOAT3(0, 0, 0) );
	sI.CreateSprite( ConvertStringToWchaer(path + "I.png"), XMFLOAT3(0, 0, 0) );
	sJ.CreateSprite( ConvertStringToWchaer(path + "J.png"), XMFLOAT3(0, 0, 0) );
	sK.CreateSprite( ConvertStringToWchaer(path + "K.png"), XMFLOAT3(0, 0, 0) );
	sL.CreateSprite( ConvertStringToWchaer(path + "L.png"), XMFLOAT3(0, 0, 0) );
	sM.CreateSprite( ConvertStringToWchaer(path + "M.png"), XMFLOAT3(0, 0, 0) );
	sN.CreateSprite( ConvertStringToWchaer(path + "N.png"), XMFLOAT3(0, 0, 0) );
	sO.CreateSprite( ConvertStringToWchaer(path + "O.png"), XMFLOAT3(0, 0, 0) );
	sP.CreateSprite( ConvertStringToWchaer(path + "P.png"), XMFLOAT3(0, 0, 0) );
	sQ.CreateSprite( ConvertStringToWchaer(path + "Q.png"), XMFLOAT3(0, 0, 0) );
	sR.CreateSprite( ConvertStringToWchaer(path + "R.png"), XMFLOAT3(0, 0, 0) );
	sS.CreateSprite( ConvertStringToWchaer(path + "S.png"), XMFLOAT3(0, 0, 0) );
	sT.CreateSprite( ConvertStringToWchaer(path + "T.png"), XMFLOAT3(0, 0, 0) );
	sU.CreateSprite( ConvertStringToWchaer(path + "U.png"), XMFLOAT3(0, 0, 0) );
	sV.CreateSprite( ConvertStringToWchaer(path + "V.png"), XMFLOAT3(0, 0, 0) );
	sW.CreateSprite( ConvertStringToWchaer(path + "W.png"), XMFLOAT3(0, 0, 0) );
	sX.CreateSprite( ConvertStringToWchaer(path + "X.png"), XMFLOAT3(0, 0, 0) );
	sY.CreateSprite( ConvertStringToWchaer(path + "Y.png"), XMFLOAT3(0, 0, 0) );
	sZ.CreateSprite( ConvertStringToWchaer(path + "Z.png"), XMFLOAT3(0, 0, 0) );
	s0.CreateSprite( ConvertStringToWchaer(path + "0.png"), XMFLOAT3(0, 0, 0) );
	s1.CreateSprite( ConvertStringToWchaer(path + "1.png"), XMFLOAT3(0, 0, 0) );
	s2.CreateSprite( ConvertStringToWchaer(path + "2.png"), XMFLOAT3(0, 0, 0) );
	s3.CreateSprite( ConvertStringToWchaer(path + "3.png"), XMFLOAT3(0, 0, 0) );
	s4.CreateSprite( ConvertStringToWchaer(path + "4.png"), XMFLOAT3(0, 0, 0) );
	s5.CreateSprite( ConvertStringToWchaer(path + "5.png"), XMFLOAT3(0, 0, 0) );
	s6.CreateSprite( ConvertStringToWchaer(path + "6.png"), XMFLOAT3(0, 0, 0) );
	s7.CreateSprite( ConvertStringToWchaer(path + "7.png"), XMFLOAT3(0, 0, 0) );
	s8.CreateSprite( ConvertStringToWchaer(path + "8.png"), XMFLOAT3(0, 0, 0) );
	s9.CreateSprite( ConvertStringToWchaer(path + "9.png"), XMFLOAT3(0, 0, 0) );
	sSpace.CreateSprite( ConvertStringToWchaer(path + "Space.png"),  XMFLOAT3(0, 0, 0));
	sLShift.CreateSprite(ConvertStringToWchaer(path + "LShift.png"), XMFLOAT3(0, 0, 0));
	sLCtrl.CreateSprite( ConvertStringToWchaer(path + "LCtrl.png"),  XMFLOAT3(0, 0, 0));
	sUP.CreateSprite(    ConvertStringToWchaer(path + "up.png"),     XMFLOAT3(0, 0, 0));
	sLeft.CreateSprite(  ConvertStringToWchaer(path + "Left.png"),   XMFLOAT3(0, 0, 0));
	sRight.CreateSprite( ConvertStringToWchaer(path + "Right.png"),  XMFLOAT3(0, 0, 0));
	sDown.CreateSprite(  ConvertStringToWchaer(path + "Down.png"),   XMFLOAT3(0, 0, 0));
	sTab.CreateSprite(   ConvertStringToWchaer(path + "Tab.png"),    XMFLOAT3(0, 0, 0));
	sRShift.CreateSprite(ConvertStringToWchaer(path + "RS.png"),     XMFLOAT3(0, 0, 0));

	padA.CreateSprite(ConvertStringToWchaer(path + "PadA.png"), XMFLOAT3(0, 0, 0));
	padB.CreateSprite(ConvertStringToWchaer(path + "PadB.png"), XMFLOAT3(0, 0, 0));
	padX.CreateSprite(ConvertStringToWchaer(path + "PadX.png"), XMFLOAT3(0, 0, 0));
	padY.CreateSprite(ConvertStringToWchaer(path + "PadY.png"), XMFLOAT3(0, 0, 0));
	padSelect.CreateSprite(ConvertStringToWchaer(path + "PadSelect.png"), XMFLOAT3(0, 0, 0));
	padPouse.CreateSprite( ConvertStringToWchaer(path + "PadPouse.png"), XMFLOAT3(0, 0, 0));
	padUp.CreateSprite(    ConvertStringToWchaer(path + "padUp.png"), XMFLOAT3(0, 0, 0));
	padRight.CreateSprite( ConvertStringToWchaer(path + "padRight.png"), XMFLOAT3(0, 0, 0));
	padLeft.CreateSprite(  ConvertStringToWchaer(path + "padLeft.png"), XMFLOAT3(0, 0, 0));
	padDown.CreateSprite(  ConvertStringToWchaer(path + "padDown.png"), XMFLOAT3(0, 0, 0));
	padLb.CreateSprite(    ConvertStringToWchaer(path + "LB.png"), XMFLOAT3(0, 0, 0));
	padRb.CreateSprite(    ConvertStringToWchaer(path + "RB.png"), XMFLOAT3(0, 0, 0));
